...
本文对应 `web-sdk-pp-ocrv6@0.2.0`，公开版本与发布状态以 [npm](https://www.npmjs.com/package/web-sdk-pp-ocrv6) 为准。
...
配置、取消/释放边界与字段语义见 [API](docs/zh-CN/api.md) 和 [性能](docs/zh-CN/performance.md)。独立示例固定使用 0.1.8，具体 API 范围与限制见各示例 README。
